...
public class ChoixJoueur extends JFrame {
	...
	/**
	 * Numéro du personnage sélectioné (1 à 3)
	 */
	...
	private void affichePerso() {
		String chemin = "personnages/perso"+this.numPerso+"marche"+1+"d"+1;
		URL ressource = getClass().getClassLoader().getResource(chemin+".gif");
		this.lblPersonnage.setIcon(new ImageIcon(ressource));
	}
